...
function TokenListHero({summary}: {summary: TTokenListSummary | undefined}): ReactElement {
	...
	return (
		<div className={'relative isolate'}>
			<div className={'mx-auto grid max-w-5xl grid-cols-1 pb-0 pt-10 md:grid-cols-2 md:pb-10 md:pt-20'}>
				<div className={'w-full'}>
					<div>
						<span
							className={
								'bg-neutral-100 text-neutral-500 rounded-md border border-neutral-400 px-3 py-1 text-xs leading-6 md:text-sm'
							}>
							{'Last update: '}
						...
						<button
							...
							<div className={'absolute right-4'}>
								<svg
									...
									<path
										d={
											'M224 0c-35.3 0-64 28.7-64 64V288c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64H224zM64 160c-35.3 0-64 28.7-64 64V448c0 35.3 28.7 64 64 64H288c35.3 0 64-28.7 64-64V384H304v64c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V224c0-8.8 7.2-16 16-16h64V160H64z'
										}
										fill={'currentColor'}
									/>
								</svg>
